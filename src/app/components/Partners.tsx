...
import { informationsPartners } from './DataImages';
    ...
    <div id='partner' className="bg-white py-0 sm:py-0">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-bold tracking-tight text-green-900 sm:text-4xl pt-4">Parceiros do agro</h2>
        ...
        {informationsPartners.map((information) => (
          <div key={information.id} className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <p className="mt-6 text-base leading-7 text-gray-600">
                {`Localização: ${information.localization}`}
              </p>
            ...
            <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
              <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                <div className="mx-auto max-w-xs px-8">
                  <Images images={information.images} />
                  <a
